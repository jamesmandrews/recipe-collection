# Apple Strudel Ribbon Puff Pastry

> Easy and rewarding puff pastry dessert with a beautiful ribbon design and warm spiced apples.
...
|------------|----------|--------|
| Puff pastry sheet, thawed | 1 sheet | 1 sheet |
| Honeycrisp apple | 1 | 1 |
| Pumpkin spice seasoning | 1 tsp | 2g |
| Lemon, juiced | ½ | ½ |
...
---
**Tags:** `#dessert` `#apple` `#puffpastry` `#fall` `#easy`
