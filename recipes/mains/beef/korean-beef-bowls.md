...
> Spicy Korean-style beef served over rice with a refreshing cucumber salad.
...
|------------|----------|--------|
| Top sirloin, sliced thin against grain | 1¾ lb | 800g |
...
|------------|----------|--------|
| Soy sauce | ⅓ cup | 80ml |
| Gochujang (Korean red pepper paste) | 3 tbsp | 45g |
| Brown sugar replacement | 3 tbsp | 36g |
| Beef broth | ¼ cup | 60ml |
...
---
**Tags:** `#korean` `#beef` `#mealprep` `#bowls` `#spicy`
